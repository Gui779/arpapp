...
public class WarehousePresenter extends BasePresenter<WarehouseView> {
    ...
    public WarehousePresenter(WarehouseView view) {
        attachView( view);
        apiService = ApiManager.getInstance().getApiService(ApiStores.class);

    }

    public void Warehouse(String store_id, String p){
        Map<String,String> map=new HashMap<>();
        map.put("store_id",store_id);
        map.put("p",p);
      /*  Disposable subscribe = apiService.Yyqindex(map)
    ...
    public void Warehousesousuo(String store_id,String p,String pro_name){
        Map<String,String> map=new HashMap<>();
        map.put("store_id",store_id);
        map.put("p",p);
    ...
    public void yqdelect(String store_id,String admin_id,String id){
        ...
        map.put("id",id);
        /*Disposable subscribe = apiService.YqDelect(map)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
