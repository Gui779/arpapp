...
public class SelectDmProductAdapter extends RecyclerView.Adapter<SelectDmProductAdapter.SelectProductHodler> {
    private Context context;
    private SelectDmProductActivity selectProductActivity;
    ...
    public SelectDmProductAdapter(Context context, SelectDmProductActivity selectProductActivity) {
