...
public class SelectProductAdapter extends RecyclerView.Adapter<SelectProductAdapter.SelectProductHodler> {
    ...
    public SelectProductAdapter(Context context,SelectProductActivity selectProductActivity) {
