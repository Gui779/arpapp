...
public class MgShAdapter extends RecyclerView.Adapter <MgShAdapter.MglistHodler>{
    private Context context;
    private Fragment mgmanageActivity;
    private List<MgShMode.DataBean> list;
    private boolean ischeck=false;
    private MgShFragment mgShFragment;
    ...
    public MgShAdapter(Context context, Fragment mgmanageActivity,MgShFragment mgShFragment) {
        this.context = context;
