...
public class AddCgProductAdapter extends RecyclerView.Adapter<AddCgProductAdapter.AddCgProductHodler> {

    private Context context;
    private List<TestAdd> list;
    private AddCgProductActivity addCgProductActivity;
    ...
    public AddCgProductAdapter(Context context,AddCgProductActivity addCgProductActivity) {
