...
public class YmckAdapter extends RecyclerView.Adapter <YmckAdapter.MglistHodler>{
    private Context context;
    private List<WmMode.DataBean> list;
    private boolean ischeck=false;
    private YmWarehouseActivity ymWarehouseActivity;
    ...
    public YmckAdapter(Context context, YmWarehouseActivity ymWarehouseActivity) {
        this.context = context;
        this.ymWarehouseActivity = ymWarehouseActivity;
    }
    ...
    public void onBindViewHolder(@NonNull final MglistHodler mglistHodler, final int i) {
        ...
        mglistHodler.cb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ymWarehouseActivity.setcheckbox(flog);
            }
        });
        ...
        mglistHodler.shthcount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ymWarehouseActivity.startActivityForResult(intent,1001);
                                ...
                                switch (whichBtn) {
                                    case BUTTON_CONFIRM:
                                        if (list.size()>0){
                                            ...
                                            ymWarehouseActivity.delectproduct(store_id+"",admin_id,id+"");
                                        }
                                        list.remove(i);
                                        notifyDataSetChanged();
                                        break;
        ...
        mglistHodler.cbprice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("name","已磨仓库");
                ymWarehouseActivity.startActivityForResult(intent,666);
            }
        });
