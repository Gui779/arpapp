...
public class MgDfhlistAdapter extends RecyclerView.Adapter <MgDfhlistAdapter.MglistHodler>{
    private Context context;
    private Fragment mgmanageActivity;
    private List<MgShMode.DataBean> list;
    private boolean ischeck=false;
    private boolean isgson;
    private MgDfhFragment mgDfhFragment;
    ...
    public MgDfhlistAdapter(Context context, Fragment mgmanageActivity, boolean isgson,MgDfhFragment mgDfhFragment) {
        this.context = context;
        this.mgmanageActivity = mgmanageActivity;
        this.isgson = isgson;
        this.mgDfhFragment = mgDfhFragment;
    }
    ...
    public void onBindViewHolder(@NonNull final MglistHodler mglistHodler, final int i) {
        ...
        mglistHodler.cb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mgDfhFragment.setcheckbox(flog);
            }
        });
