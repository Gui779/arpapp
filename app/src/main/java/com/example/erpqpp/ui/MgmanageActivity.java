 ...
 * 木工管理
 */
public class MgmanageActivity extends BaseActivity implements TitleBarView.BtnClickListener {
    ...
    private void initdata() {
        tbvTitlebar.setMainTitle("木工管理");
        tbvTitlebar.setRightTitleColor(Color.WHITE);
        tbvTitlebar.setRightTitleText("新增");
        tbvTitlebar.setTitleBarListener(MgmanageActivity.this);
        ...
        mFragments.add(new MgShFragment());
        mFragments.add(new MgDfhFragment());
        mFragments.add(new MgFhFragment());
        mFragments.add(new MgSfjlFragment());
