...
public class SendGoodsDetailsAdapter extends RecyclerView.Adapter<SendGoodsDetailsAdapter.MarkettjHodler> {
    private Context context;
    private List<SendGoodsDetailsMode.DataBean.ProListBean> data;


    public List<SendGoodsDetailsMode.DataBean.ProListBean> getData() {
        return data;
    }

    public void setData(List<SendGoodsDetailsMode.DataBean.ProListBean> data) {
        this.data = data;
    }

    public SendGoodsDetailsAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull MarkettjHodler markettjHodler, int i) {
        ...
        List<SendGoodsDetailsMode.DataBean.ProListBean.Unit> unit_list = data.get(i).getUnit_list();

        SendGoodsDetailsZiAdapter sendGoodsDetailsZiAdapter=new SendGoodsDetailsZiAdapter(context);
        sendGoodsDetailsZiAdapter.setUnit_list(unit_list);
        markettjHodler.rc.setAdapter(sendGoodsDetailsZiAdapter);
