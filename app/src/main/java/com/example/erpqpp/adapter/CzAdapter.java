...
public class CzAdapter extends RecyclerView.Adapter<CzAdapter.SingletonHodler> {
    private Context context;
    private  List<CzMode.DataBean> list;
    private Itemclick item;

    public  List<CzMode.DataBean> getList() {
        return list;
    }

    public void setList( List<CzMode.DataBean> list) {
        this.list = list;
    }
