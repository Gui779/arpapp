...
public class SelectShAdapter extends RecyclerView.Adapter<SelectShAdapter.SelectColorHodler> {

    private Context context;
    private Itemclick item;
    private List<SelectShMode.DataBean.ListBean> list;

    public List<SelectShMode.DataBean.ListBean> getList() {
        return list;
    }

    public void setList(List<SelectShMode.DataBean.ListBean> list) {
        this.list = list;
    }

    public SelectShAdapter(Context context) {
