...
public class DmlistAdapter extends RecyclerView.Adapter <DmlistAdapter.MglistHodler>{
    private Context context;
    private Fragment mgmanageActivity;
    private List<DmMode.DataBean> list;
    private boolean ischeck=false;
    private DmFhFragment dmFhFragment;
    ...
    public DmlistAdapter(Context context, Fragment mgmanageActivity,DmFhFragment dmFhFragment) {
        this.context = context;
        this.mgmanageActivity = mgmanageActivity;
        this.dmFhFragment = dmFhFragment;
    }
