...
public class MarkettjDetailZiAdapter extends RecyclerView.Adapter<MarkettjDetailZiAdapter.MarkettjDetailsZiHodler>{
    private Context context;
    List<MarkettjDetailsMode.DataBean.ProListBean.Unit> unit_list;

    public List<MarkettjDetailsMode.DataBean.ProListBean.Unit> getUnit_list() {
        return unit_list;
    }

    public void setUnit_list(List<MarkettjDetailsMode.DataBean.ProListBean.Unit> unit_list) {
        this.unit_list = unit_list;
    }

    public MarkettjDetailZiAdapter(Context context) {
