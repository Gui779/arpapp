...
public class SqShAdapter extends RecyclerView.Adapter <SqShAdapter.MglistHodler>{
    private Context context;
    private Fragment mgmanageActivity;
    private  List<SqMode.DataBean> list;
    private boolean ischeck=false;
    private SqShFragment sqShFragment;
    ...
    public SqShAdapter(Context context, Fragment mgmanageActivity, SqShFragment sqShFragment) {
        this.context = context;
        this.mgmanageActivity = mgmanageActivity;
        this.sqShFragment = sqShFragment;
    }
                                ...
                                switch (whichBtn) {
                                    case BUTTON_CONFIRM:
                                        if (list.size()>0){
                                            ...
                                            sqShFragment.delectproduct(store_id+"",id+"");
                                        }
                                        list.remove(i);
                                        notifyDataSetChanged();
                                        break;
