...
public class MglistAdapter extends RecyclerView.Adapter <MglistAdapter.MglistHodler>{
    ...
    public MglistAdapter(Context context, Fragment mgmanageActivity,boolean isgson,MgFhFragment mgFhFragment) {
        this.context = context;
        this.mgmanageActivity = mgmanageActivity;
        this.isgson = isgson;
        this.mgFhFragment = mgFhFragment;
    }
