...
public class SingletonAdapter extends RecyclerView.Adapter<SingletonAdapter.SingletonHodler> {
    private Context context;
    private List<SingletonMode.DataBean> list;
    private Itemclick item;

    public List<SingletonMode.DataBean> getList() {
        return list;
    }

    public void setList(List<SingletonMode.DataBean> list) {
        this.list = list;
    }

    public SingletonAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull final SingletonHodler singletonHodler, final int i) {
        singletonHodler.name.setText(list.get(i).getUnit_name());
