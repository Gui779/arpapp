...
public class CglistAdapter extends RecyclerView.Adapter<CglistAdapter.CglistHodler>{
    private Context context;
    private String name;
    private List<CgStayGoMode.DataBean.ListBean> list;
    private CgStayGoFragment cgStayGoFragment;


    public void setCgStayGoFragment(CgStayGoFragment cgStayGoFragment) {
    ...
    public CglistAdapter(Context context) {
      ...
      //  cglistHodler.zonge.setText("总额: "+list.get(i).getTotal());
        ...
        cglistHodler.shouhuo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (name.equals("出货")){
                    cgStayGoFragment.Yzjump(list.get(i).getOrder_id()+"");
