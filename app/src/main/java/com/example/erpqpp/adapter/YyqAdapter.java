...
public class YyqAdapter extends RecyclerView.Adapter <YyqAdapter.MglistHodler>{
    private Context context;
    private List<WmMode.DataBean> list;
    private boolean ischeck=false;
    private YyqWarehouseActivity yyqWarehouseActivity;
    ...
    public YyqAdapter(Context context, YyqWarehouseActivity yyqWarehouseActivity) {
        this.context = context;
        this.yyqWarehouseActivity = yyqWarehouseActivity;
    }

    @NonNull
    @Override
    public MglistHodler onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_yq, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MglistHodler mglistHodler, final int i) {
        ...
        mglistHodler.tvcount.setText("数量");
        mglistHodler.cbprice.setText(list.get(i).getCost()+"");
        ...
        mglistHodler.cb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                yyqWarehouseActivity.setcheckbox(flog);
            }
        });
        ...
        mglistHodler.shthcount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                yyqWarehouseActivity.startActivityForResult(intent,1001);
                                ...
                                switch (whichBtn) {
                                    case BUTTON_CONFIRM:
                                        if (list.size()>0){
                                            ...
                                            yyqWarehouseActivity.delectproduct(store_id+"",admin_id,id+"");
                                        }
                                        list.remove(i);
                                        notifyDataSetChanged();
                                        break;
        ...
        mglistHodler.cbprice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context, UpdataPriceActivity.class);
                intent.putExtra("store_id",list.get(i).getStore_id()+"");
                intent.putExtra("id",list.get(i).getId()+"");
                intent.putExtra("name","已油漆仓库");
                yyqWarehouseActivity.startActivityForResult(intent,666);
            }
        });
