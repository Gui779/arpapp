...
public class SqFhlistAdapter extends RecyclerView.Adapter <SqFhlistAdapter.MglistHodler>{
    private Context context;
    private Fragment mgmanageActivity;
    private List<SqMode.DataBean> list;
    private boolean ischeck=false;
    private SqFhFragment sqFhFragment;
    ...
    public SqFhlistAdapter(Context context, Fragment mgmanageActivity,SqFhFragment sqFhFragment) {
        this.context = context;
        this.mgmanageActivity = mgmanageActivity;
        this.sqFhFragment = sqFhFragment;
    }
    ...
    public void onBindViewHolder(@NonNull final MglistHodler mglistHodler, final int i) {
       ...
       mglistHodler.cb.setChecked(list.get(i).isIscheck());
        ...
        mglistHodler.countname.setText("发货数量");
