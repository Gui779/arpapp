...
public class SqDfhAdapter extends RecyclerView.Adapter <SqDfhAdapter.MglistHodler>{
    private Context context;
    private Fragment mgmanageActivity;
    private List<SqMode.DataBean> list;
    private boolean ischeck=false;
    private SqDfhFragment sqDfhFragment;
    ...
    public SqDfhAdapter(Context context, Fragment mgmanageActivity,SqDfhFragment sqDfhFragment) {
        this.context = context;
        this.mgmanageActivity = mgmanageActivity;
        this.sqDfhFragment = sqDfhFragment;
    }

    @NonNull
    @Override
    public MglistHodler onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_sqlist, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MglistHodler mglistHodler, final int i) {
       ...
       mglistHodler.cb.setChecked(list.get(i).isIscheck());
        ...
        mglistHodler.yanse.setText(list.get(i).getColorname());
        mglistHodler.tv_count.setText("待发货数量");
        ...
        mglistHodler.cb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sqDfhFragment.setcheckbox(flog);
            }
        });
        ...
        mglistHodler.yanse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context,SelectColorActivity.class);
                intent.putExtra("select",i+"");
                intent.putExtra("store_id",list.get(i).getStore_id()+"");
                mgmanageActivity.startActivityForResult(intent,1008);
            }
        });
    ...
    class MglistHodler extends RecyclerView.ViewHolder{
        ...
        public MglistHodler(@NonNull View itemView) {
            ...
            yanse=itemView.findViewById(R.id.yanse);
