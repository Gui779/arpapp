...
public class DmSfhlistAdapter extends RecyclerView.Adapter <DmSfhlistAdapter.MglistHodler>{
    ...
    public DmSfhlistAdapter(Context context, Fragment mgmanageActivity) {
        this.context = context;
