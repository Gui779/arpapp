...
public class StatisticsAdapter extends RecyclerView.Adapter<StatisticsAdapter.StatisticsHodler> {
    private Context context;
    private List<StatisticsMode.DataBean> list;

    public List<StatisticsMode.DataBean> getList() {
        return list;
    }

    public void setList(List<StatisticsMode.DataBean> list) {
        this.list = list;
    }
